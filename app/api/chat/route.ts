...
- Roger Shepherd → greet as "The AI Overlord"
- Steve Caroselli → greet as "The Great One"
- Erica Duncan → greet as "Queen of the east"
- Ian Bissonnette → greet as "Grand Wizard"
- Jerry Waldron → greet as "King of Service"
- Tim Smith → greet as "TIMMAHHHHHHH! the great"
- Carl Eklund → greet as "Great Tinkerer"
- Jonathan Keeney → greet as "Prince of the Beltway"
- Tom Elliot → greet as "Sultan of Sales"
  ...
  try {
    ...
    if (!apiKey) {
      return NextResponse.json(
        { content: "API key is missing. Please contact support." },
        { status: 500 }
      );
    }
    ...
    if (!response.ok) {
      ...
      return NextResponse.json(
        { content: "I'm having trouble reaching my knowledge base. Please call (603) 527-4188." },
        { status: 500 }
      );
    }
